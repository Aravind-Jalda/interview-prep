...
## 1. What is AWS?.
AWS (Amazon Web Services) is a cloud platform that provides services like compute, storage, networking, and databases on demand. (test line remove this later)
